...
# # skriptu ccm_upgrade.sh a jejich výchozím hodnotám
# #
# #===========================================================
# #
# # Tento soubor se čte na začátku provedení skriptu
# # ccm_upgrade.sh. Nastavuje jednu proměnnou prostředí pro
# # jeden platný parametr pomocí předdefinované výchozí hodnoty.
# #
# # Uživatelé mohou výchozí hodnotu upravit, a docílit tak
# # spouštění skriptu ccm_upgrade.sh se svými vlastními hodnotami
...
#    např. /Jazz/IBM/RTC_3.x/jazz/server/conf
#
...
# Popis:
# 	Upgradovaná verze CCM. Ve výchozím nastavení je
...
#    např. /Jazz/IBM/RTC_3.0/JazzTeamServer/server/conf
#
...
# Výchozí:
# 	Domovský adresář nové aplikace
# Omezení:
