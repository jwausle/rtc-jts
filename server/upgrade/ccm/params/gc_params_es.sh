...
#  (c) Copyright IBM Corporation 2015. Reservados todos los derechos.
#
...
# Descripción:
# 	Vía de acceso completa al directorio de inicio de la aplicación en instalaciones 3.0.1.
#  Valor predeterminado:
# 	<ninguno>
# Restricciones:
#  - es un parámetro obligatorio
#  - <vía acceso dir> debe ser un directorio existente que termine en 'server/conf'
#    por ej. /QIBM/UserData/JazzTeamServer301Backup/server/conf
#
...
# Descripción:
# 	Raíz de contexto de aplicación del servidor 3.0.1.
# Valor predeterminado:
# 	gc
# Restricciones:
...
# Descripción:
# 	La versión 3.0.x que se está actualizando. De forma predeterminada, se
...
# Descripción:
# 	Vía de acceso completa al directorio raíz de Tomcat en la instalación de 3.0.1.
# Valor predeterminado:
# 	<ninguno>
# Restricciones:
...
# Descripción:
# 	Vía de acceso al directorio de inicio de la aplicación de la instalación 4.0.
# Valor predeterminado:
# 	conf
# Restricciones:
#  - Solo se acepta en actualizaciones de RTC, QM, GC y RM
#  - Cuando se acepta, es un parámetro obligatorio
#  - <vía acceso dir> debe ser un directorio existente que termine en 'server/conf'
#    por ej. /Jazz/IBM/GC_6.0/JazzTeamServer/server/conf
#
...
# Descripción:
# 	Vía de acceso completa al directorio de inicio de JTS de la instalación 4.0.
# Valor predeterminado:
...
# Descripción:
# 	Raíz de contexto del servidor de JTS 4.0.
# Valor predeterminado:
# 	jts
# Restricciones:
...
# Descripción:
# 	Vía de acceso al directorio raíz de Tomcat de la aplicación de la instalación 4.0.
# Valor predeterminado:
# 	<ninguno>
#
NEW_TOMCAT_HOME=
...
# Descripción:
# 	Vía de acceso al directorio raíz de Tomcat de JTS de la instalación 4.0.
#  Valor predeterminado:
# 	<ninguno>
#
NEW_JTS_TOMCAT_HOME=

# Parámetro: -ignoreJTSVersionCheck
# Uso: -ignoreJTSVersionCheck
# Descripción:
# 	No intente comprobar si la versión de la aplicación es
#  compatible con la versión de Jazz Team Server ubicada en newJTSHome.
#  Valor predeterminado:
# 	<ninguno>
# Restricciones:
#  - Los únicos valores válidos están vacíos o son 'ignoreJTSVersionCheck'
#
...
#   noVerify
# Restricciones:
#  - Los únicos valores válidos son en blanco o 'noVerify'
#
# NO_VERIFY=
NO_VERIFY=noVerify
