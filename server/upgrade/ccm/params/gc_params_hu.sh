#!/bin/sh
# *******************************************************************************
#  Licenc hatálya alá eső anyagok - Az IBM tulajdona
#  (c) Copyright IBM Corporation 2015. Minden jog fenntartva.
#
...
# # gc_upgrade.sh parancsfájl paramétereinek, és azok
# # alapértelmezett értékeit
# #
# #===========================================================
# #
# # Ezt a fájlt a gc_upgrade.sh parancsfájl végrehajtásának
...
# # gc_upgrade.sh parancsfájl saját értékekkel való elindításához,
...
# Leírás:
# 	Az alkalmazás alapkönyvtárának teljes útvonala a 3.0.1 telepítésben.
# Alapértelmezés:
# 	<nincs>
# Megszorítások:
#  - ez egy kötelező paraméter
#  - a <könyvtár_útvonal> csak egy 'server/conf' végződésű létező könyvtár lehet
#    például /QIBM/UserData/JazzTeamServer301Backup/server/conf
#
...
# Leírás:
# 	Az alkalmazás kontextusgyökere a 3.0.1 kiszolgálón.
# Alapértelmezés:
# 	gc
# Megszorítások:
...
# Leírás:
# 	A frissítendő 3.0.x változat. Alapértelmezés szerint ez a repotools
...
# Leírás:
# 	A Tomcat gyökérkönyvtár teljes útvonala a 3.0.1 telepítésben.
# Alapértelmezés:
# 	<nincs>
# Megszorítás:
...
# Leírás:
# 	Az alkalmazás alapkönyvtárának útvonala a 4.0 telepítésben.
# Alapértelmezés:
# 	conf
# Megszorítások:
#  - Csak RTC, QM, GC és RM frissítés esetén elfogadott
#  - Ha elfogadott, akkor ez egy kötelező paraméter
#  - A <könyvtár_útvonal> csak egy 'server/conf' végződésű létező könyvtár lehet
#    például /Jazz/IBM/GC_6.0/JazzTeamServer/server/conf
#
...
# Leírás:
# 	A JTS alapkönyvtár teljes útvonala a 4.0 telepítésben.
# Alapértelmezett:
...
# Leírás:
# 	A 4.0 JTS kiszolgáló kontextusgyökere.
# Alapértelmezés:
# 	jts
# Megszorítások:
#  - A <root> csak egy egyedülálló érvényes könyvtárnév lehet (vagyis nincs bevezető törtvonal)
...
# Leírás:
# 	Az alkalmazás Tomcat gyökérkönyvtárának útvonala a 4.0 telepítésben.
# Alapértelmezés:
# 	<nincs>
#
NEW_TOMCAT_HOME=
...
# Leírás:
# 	A JTS Tomcat gyökérkönyvtár útvonala a 4.0 telepítésben.
# Alapértelmezés:
# 	<nincs>
#
NEW_JTS_TOMCAT_HOME=

# Paraméter: -ignoreJTSVersionCheck
# Használat: -ignoreJTSVersionCheck
# Leírás:
# 	Ne kísérelje meg annak ellenőrzését, hogy az alkalmazásváltozat
#   kompatibilis-e a neJTSHome paraméterben megadott helyen található Jazz Team Server változattal.
# Alapértelmezés:
# 	<nincs>
#  Megszorítások:
#  - A kizárólag érvényes értékek: üres vagy 'ignoreJTSVersionCheck'
#
