...
#    por ej. /Jazz/IBM/RQM_3.x/jazz/server/conf
#
...
# 	conf
# Restricciones:
#  - Solo se acepta para la actualización de RTC, QM y RM
#  - Cuando se acepta, es un parámetro obligatorio
#  - <vía acceso dir> debe ser un directorio existente que termine en 'server/conf'
#    por ej. /Jazz/IBM/RQM_3.0/JazzTeamServer/server/conf
#
