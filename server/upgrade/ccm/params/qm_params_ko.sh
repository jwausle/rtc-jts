...
#    예: /Jazz/IBM/RQM_3.x/jazz/server/conf
#
...
#  - <dir path>는 'server/conf'로 끝나는 기존 디렉토리여야 합니다.
#    예: /Jazz/IBM/RQM_3.0/JazzTeamServer/server/conf
#
