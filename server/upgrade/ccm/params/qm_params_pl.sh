...
# # skryptu qm_upgrade.sh i ich domyślnym wartościom
# #
# #===========================================================
# #
# # Ten plik jest odczytywany na początku wykonania skryptu
# # qm_upgrade.sh. Ustawia on po jednej zmiennej
...
# # uruchomienia skryptu qm_upgrade.sh z jego własnymi
...
#    np. /Jazz/IBM/RQM_3.x/jazz/server/conf
#
...
#  - <ścieżka do katalogu> musi być ścieżką do istniejącego katalogu zakończoną łańcuchem server/conf
#    np. /Jazz/IBM/RQM_3.0/JazzTeamServer/server/conf
#
