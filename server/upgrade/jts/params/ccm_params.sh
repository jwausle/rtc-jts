...
# # ccm_upgrade.sh script parameters and their default values
# #
# #===========================================================
# #
# # This file is read at the beginning of the ccm_upgrade.sh
...
# # launch the ccm_upgrade.sh script with their own values
...
#    e.g. /Jazz/IBM/RTC_3.x/jazz/server/conf
#
...
# Description:
# 	The CCM version that is being upgraded.  By default, this is
...
#  - <dir path> must be an existing directory ended by 'server/conf'
#    e.g. /Jazz/IBM/RTC_3.0/JazzTeamServer/server/conf
#
...
# Description:
# 	Path to the JTS server configuration directory of the JTS that the new installation will use
# Default:
