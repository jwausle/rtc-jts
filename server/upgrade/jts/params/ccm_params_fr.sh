...
# # aux paramètres de script ccm_upgrade.sh ainsi que leurs valeurs par défaut
# #
# #===========================================================
# #
# # Ce fichier est lu au début de l'exécution du script
# # ccm_upgrade.sh. Il associe une variable d'environnement
# # par paramètre valide à une valeur par défaut prédéfinie.
# #
# # Les utilisateurs peuvent modifier la valeur par défaut
# # pour lancer le script ccm_upgrade.sh avec leurs propres
...
#    par exemple /Jazz/IBM/RTC_3.x/jazz/server/conf
#
...
# Description :
# 	Version de CCM mise à niveau.  Par défaut, elle est
...
#    par exemple /Jazz/IBM/RTC_3.0/JazzTeamServer/server/conf
#
...
# Description:
# 	Chemin d'accès au répertoire de configuration du serveur JTS que la nouvelle installation va utiliser
# Valeur par défaut :
