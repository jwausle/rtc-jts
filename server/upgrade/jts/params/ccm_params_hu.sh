...
# # ccm_upgrade.sh parancsfájl paramétereinek, és azok
# # alapértelmezett értékeit
# #
# #===========================================================
# #
# # Ezt a fájlt a ccm_upgrade.sh parancsfájl végrehajtásának
...
# # ccm_upgrade.sh parancsfájl saját értékekkel való elindításához,
...
#    például /Jazz/IBM/RTC_3.x/jazz/server/conf
#
...
# Leírás:
# 	A frissítendő CCM változat.  Alapértelmezés szerint ez a repotools
...
#  - A <könyvtár_útvonal> csak egy 'server/conf' végződésű létező könyvtár lehet
#    például /Jazz/IBM/RTC_3.0/JazzTeamServer/server/conf
#
...
# Leírás:
# 	Az új telepítés által használt JTS kiszolgáló JTS kiszolgáló konfigurációs könyvtárának útvonala
# Alapértelmezés:
# 	Az új alkalmazás alapkönyvtára
# Megszorítások:
# - a <könyvtár útvonala> egy létező könyvtár kell, hogy legyen a következő végződéssel: 'server\conf'
#
NEW_JTS_HOME=
