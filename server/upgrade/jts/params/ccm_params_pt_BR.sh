...
# # parâmetros de ccm_upgrade.sh e seus valores padrão
# #
# #===========================================================
# #
# #  Este arquivo é lido no início da execução do script
# # ccm_upgrade.sh. Ele configura uma variável de ambiente
# # por parâmetro válido com um valor padrão predefinido.
# #
# # Usuários podem desejar modificar o valor padrão para
# # ativar o script ccm_upgrade.sh com seus próprios valores
...
#    por exemplo, /Jazz/IBM/RTC_3.x/jazz/server/conf
#
...
# Descrição:
# 	A versão CCM que está sendo atualizada.  Por padrão, isso é
...
#    ex.: /Jazz/IBM/RTC_3.0/JazzTeamServer/server/conf
#
...
# Descrição:
# 	Caminho para o diretório de configuração do servidor JTS do JTS que a nova instalação irá usar
# Padrão:
# 	O diretório inicial do novo aplicativo
# Restrições:
