...
#    например: /Jazz/IBM/RTC_3.x/jazz/server/conf
#
...
# Описание:
# 	Обновляемая версия CCM.  По умолчанию она
...
#    например: /Jazz/IBM/RTC_3.0/JazzTeamServer/server/conf
#
