...
# #############################################################
# #
# # gm upgrade.sh komut dosyasının parametrelerine karşılık gelen
# # ortam değişkenlerini ve bunların varsayılan değerlerini tanımlayın
# #
# #===========================================================
# #
# # Bu dosya, gm upgrade.sh komut dosyası yürütmesinin
...
# # gm_upgrade.sh komut dosyasını başlatmak için
...
#    örn. /Jazz/IBM/RQM_3.x/jazz/server/conf
#
...
#    örn. /Jazz/IBM/RQM_3.0/JazzTeamServer/server/conf
#
