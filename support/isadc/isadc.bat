...
setlocal
rem (C) COPYRIGHT International Business Machines Corp., 2004-2014. All Rights Reserved * Licensed Materials - Property of IBM
rem
...
rem JAVA_HOME=PATH_REPLACE_DURING_INSTALL
